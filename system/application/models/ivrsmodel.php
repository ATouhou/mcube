	...
	function getIvrslist($bid,$ofset='0',$limit='20'){
		...
		foreach($rst as $rec){
			...
			if($opt_add || $opt_view || $opt_delete){
				...
				$act .= ($opt_add)? '<li> <a href="AddOption/'.$r['ivrsid'].'/0/'.$r['optid'].'"  class="btn-danger" data-toggle="modal" data-target="#modal-responsive"><span class="glyphicon glyphicon-plus" title="Add Option" >&nbsp;AddOption</span></a></li>':'';
		...
		foreach($rst as $rec){
			...
			if($opt_add||$opt_view){
				$act = '<div class="btn-group">&nbsp;&nbsp;
							<a class="dropdown-toggle" data-toggle="dropdown" style=";font-weight:bold;"> Action <span class="caret"></span></a>
							<ul class="dropdown-menu" style="text-align:left;">';
				$act .= ($opt_add)? '<li><a href="ivrs/undelete/'.$r['ivrsid'].'" class="deleteClass"><img src="system/application/img/icons/undelete.png"  style="vertical-align:top;" id="'.$r['ivrsid'].'" title="Undelete" />UnDelete</a></li>':'';
		...
		foreach($rst as $rec){
			...
			if($opt_add || $opt_view || $opt_delete){
				$act = '<div class="btn-group">&nbsp;&nbsp;
								<a class="dropdown-toggle" data-toggle="dropdown" style=";font-weight:bold;"> Action <span class="caret"></span></a>
								<ul class="dropdown-menu" style="text-align:left;">';
				$act .= '<li><a href="IVRSEditReport/'.$rec['hid'].'"><span title="Edit" class="glyphicon glyphicon-edit">&nbsp;Edit Report</span></a></li>';
