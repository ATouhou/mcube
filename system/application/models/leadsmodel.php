		...
		foreach($rst as $rec){
			...
			if($opt_add || $opt_view || $opt_delete){
				$act = '<div class="btn-group">&nbsp;&nbsp;
							<a class="dropdown-toggle" data-toggle="dropdown" style=";font-weight:bold;"> Action <span class="caret"></span></a>
							<ul class="dropdown-menu" style="text-align:left;">';
				$act .= '<li><a href="'.base_url().'leads/undelete/'.$r['leadid'].'/'.$ltype.'"><span title="Delete" class="glyphicon glyphicon-refresh">&nbsp;UnDelete</span></a></li>';
				$act .= '</ul></div>';
				$data['action'] = $act;
			}
			$i++;
		...
		foreach($rst as $rec){
			...
			if($opt_add || $opt_view || $opt_delete){
				$act = '<div class="btn-group">&nbsp;&nbsp;
							...
							<ul class="dropdown-menu" style="text-align:left;">';
				if($type == 'del'){
					$act .= '<li><a href="'.base_url().'leads/delete_leadsgrp/'.$rec['gid'].'/1"><span title="Delete" class="glyphicon glyphicon-refresh">&nbsp;UnDelete</span></a></li>';
				}else{
