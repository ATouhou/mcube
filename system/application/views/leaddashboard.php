...
<div id="main-content">
   <div class="page-title">
      ...
      <h3><strong>Leads Dashboard</strong></h3>
   </div>
   <!--<div class="row">
      <div class="col-md-12">
                                             ...
                                             <table class="table tabdes table-striped table-hover" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <?php
                                                   ...
                                                   echo "<tr class='sortable  coldes bd-3 bg-opacity-20  fade in ui-sortable'>
                                                   		<td width='60%'><label><a href='EmpTrackReport/".$lead_empgroupwise_todaycalls[$i]['eid']."' >".$lead_empgroupwise_todaycalls[$i]['employee']."</a></label></td> 
