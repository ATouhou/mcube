...
<div id="main-content">
   <div class="page-title">
      ...
      <h3><strong>IVRS Dashboard</strong></h3>
   </div>
										...
										<div class="col-md-12">
										  <div class="row m-b-10">
                                           <div class="withScroll" data-height="320" style="min-height:300px;">
                                            ...
                                            <a href="dashboard/weekpopup/ivrs"  class="btn-danger btn btn-default btn-icon btn-rounded" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div>
                                         </div>
                                       </div>
										...
										<div class="col-md-12">
                                          ...
                                          <div class="withScroll" data-height="320" style="min-height:300px;">
											<div class="thumbnail">
                                             ...
                                             <div class="overlay">
                                            <div class="thumbnail-actions">
                                            <a href="dashboard/callbytime/ivrs"  class="btn-danger btn btn-default btn-icon btn-rounded" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div>
                                          </div>
                                       </div>
									  ...
									  <div class="row">
										<div class="col-md-12">
                                          ...
                                          <div class="withScroll" data-height="320" style="min-height:300px;">
                                             ...
                                             <div class="overlay">
                                            <div class="thumbnail-actions">
                                            <a href="dashboard/callbyweek/ivrs"  class="btn-danger btn btn-default btn-icon btn-rounded" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div> 
                                          </div>
                                       </div>
