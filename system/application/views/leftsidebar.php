		...
		<nav id="sidebar">
            <div id="main-menu">
                <ul class="sidebar-nav">
                    <li class="<?=$cls1[0].$cls1[1].$cls1[84].$cls1[85].$cls1[86].$cls1[87].$cls1[88];?>">
						...
						<ul class="submenu collapse" >
							<li class="">
								<a href="<?php echo site_url($menubar[0]);?>"><span class="sidebar-text"><b><?php echo "Home";?></b></span><span class="fa arrow"></span></a>
                			 ...
                			 <ul class="submenu collapse">
							   ...
							   <li><a href="#"><span class="sidebar-text"><b>Contacts</b></span><span class="fa arrow"></span></a>
								...
								<ul class="menu2 submenu collapse">
									...
									<!--<li class="<?=$cls2[95];?>"><a href="<?php echo site_url($menubar[95].'/all');?>"><span class="sidebar-text"><?php echo "Positive Calls";?></span></a></li>
									<li class="<?=$cls2[96];?>"><a href="<?php echo site_url($menubar[96].'/all');?>"><span class="sidebar-text"><?php echo "Negative Calls";?></span></a></li>-->
				    ...
				    <li class="<?=$cls1[22].$cls1[23].$cls1[24].$cls1[25].$cls1[26].$cls1[27].$cls1[28].$cls1[29].$cls1[30].$cls1[31].$cls1[32].$cls1[33].$cls1[34].$cls1[35].$cls1[36].$cls1[64].$cls1[81].$cls1[82].$cls1[83]?>">
						...
						<ul class="submenu collapse">
							...
							<li class="<?=$cls2[30];?>"><a href="<?php echo site_url($menubar[30].'/0');?>"><span class="sidebar-text"><?php echo $this->lang->line('blocklist');?></span></a></li>
				...
				<li class="<?=$cls1[47].$cls1[48].$cls1[49].$cls1[50].$cls1[51].$cls1[52].$cls1[53].$cls1[56].$cls1[57].$cls1[92];?>">
					...
					<?php }?>
				<li class="<?=$cls1[46].$cls1[65].$cls1[66].$cls1[67].$cls1[68].$cls1[63].$cls1[60].$cls1[69].$cls1[70].$cls1[71].$cls1[72].$cls1[73].$cls1[74].$cls1[75].$cls1[76].$cls1[77].$cls1[78].$cls1[79].$cls1[80].$cls1[95].$cls1[96].$cls1[97]?>">
					<a href="#" title="Reports"><i class="fa fa-plus-square"></i><span class="sidebar-text"><?php echo $this->lang->line('label_report');?></span><span class="fa arrow"></span></a>
						<ul class="submenu collapse">
							...
							<li class="<?=$cls2[97];?>"><a href="<?php echo site_url($menubar[97].'/0');?>"><span class="sidebar-text"><?php echo "MTracker Report";?></span></a></li>
							<?php } ?> 
							<li class="<?=$cls2[71];?>"><a href="<?php echo site_url($menubar[71].'/0');?>"><span class="sidebar-text"><?php echo "SMS Report";?></span></a></li>
							<li class="<?=$cls2[72];?>"><a href="<?php echo site_url($menubar[72].'/0');?>"><span class="sidebar-text"><?php echo "Follow ups Report";?></span></a></li>
